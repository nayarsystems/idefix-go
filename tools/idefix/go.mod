...
require (
	...
	github.com/nayarsystems/idefix-go v0.0.8
	github.com/nayarsystems/idefix/libraries/bevents v0.0.5
)
...
require (
	...
	github.com/nayarsystems/idefix-go/minips v0.0.3 // indirect
